    ...
    <div>
          ...
          <div className="relative">
            <div className="bg-card rounded-2xl shadow-xl p-6">
              ...
              <div className="absolute bottom-4 left-4 bg-card rounded-lg shadow-lg p-3">
                <div className="text-primary font-semibold">+12kg CO₂</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-muted-foreground">
                See exactly how much CO₂ you've saved and waste you've diverted from landfills with every swap.
              </p>
            </CardContent>
          </Card>
            ...
            {[1, 2, 3, 4].map((item) => (
              <Card key={item} className="overflow-hidden hover:shadow-md transition-shadow">
                <div className="aspect-square bg-muted relative">
                  <img
                    src="/kitchen-utensils-set.png"
                    alt="Kitchen utensils set"
                    className="w-full h-full object-cover"
                  />
                </div>
                <CardContent className="p-4">
                  <h4 className="font-medium text-foreground mb-2">Kitchen Utensils Set</h4>
                  <p className="text-sm text-muted-foreground mb-3">Sustainable bamboo kitchen tools</p>
      ...
      <section className="py-16 bg-foreground text-background">
        <div className="text-center">
          ...
          <Button className="px-8 py-3 text-lg" variant="secondary">
            Join EcoSwap Free
